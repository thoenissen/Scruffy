...
public static class DpsReportAnalyzer
{
    ...
    {
        return [
                   DpsReportExpansionEntryBuilder.CreateCoreGame(),
                   DpsReportExpansionEntryBuilder.CreateHeartsOfThorns(),
                   DpsReportExpansionEntryBuilder.CreatePathOfFire(),
                   DpsReportExpansionEntryBuilder.CreateIcebroodSaga(),
                   DpsReportExpansionEntryBuilder.CreateEndOfDragons(),
                   DpsReportExpansionEntryBuilder.CreateSecretsOfTheObscure(),
                   DpsReportExpansionEntryBuilder.CreateJanthirWilds(),
