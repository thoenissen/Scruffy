...
/// <summary>
/// Selection of a discord role which should be edited
/// </summary>
public class GuildActivityDiscordMessageEditDialogElement : DiscordRoleSelectionDialogElement
{
    #region Constructor
    ...
    public GuildActivityDiscordMessageEditDialogElement(LocalizationService localizationService)
