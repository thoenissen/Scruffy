...
/// </summary>
public class GuildActivityDiscordVoiceEditDialogElement : DiscordRoleSelectionDialogElement
{
    #region Constructor
    ...
    public GuildActivityDiscordVoiceEditDialogElement(LocalizationService localizationService)
