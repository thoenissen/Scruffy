...
/// </summary>
public class GuildActivityDiscordVoiceAddDialogElement : DiscordRoleSelectionDialogElement
{
    #region Constructor
    ...
    public GuildActivityDiscordVoiceAddDialogElement(LocalizationService localizationService)
