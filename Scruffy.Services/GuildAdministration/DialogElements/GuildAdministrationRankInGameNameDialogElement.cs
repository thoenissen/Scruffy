...
/// </summary>
public class GuildAdministrationRankInGameNameDialogElement : DialogEmbedMessageElementBase<string>
{
    #region Fields
    ...
    public GuildAdministrationRankInGameNameDialogElement(LocalizationService localizationService)
