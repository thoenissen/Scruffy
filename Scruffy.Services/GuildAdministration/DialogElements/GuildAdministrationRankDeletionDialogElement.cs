...
/// </summary>
public class GuildAdministrationRankDeletionDialogElement : DialogReactionElementBase<bool>
{
    #region Fields
    ...
    public GuildAdministrationRankDeletionDialogElement(LocalizationService localizationService)
