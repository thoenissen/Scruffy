...
public class RaidCommandModule : LocatedCommandModuleBase
{
    ...
    public async Task Guides(CommandContext commandContext)
    {
        ...
        stringBuilder.AppendLine($"{DiscordEmojiService.GetGuildEmoji(commandContext.Client, 848908580749049866)} {Formatter.MaskedUrl("Cardinal Adina", new Uri("https://wiki.guildwars2.com/wiki/Cardinal_Adina"))} ({Formatter.MaskedUrl("Mukluk", new Uri("https://www.youtube.com/watch?v=T_RwWm0Jj4k"))} - {Formatter.MaskedUrl("MightyTeapot", new Uri("https://www.youtube.com/watch?v=UY1iBmxDD6M"))})");
        stringBuilder.AppendLine($"{DiscordEmojiService.GetGuildEmoji(commandContext.Client, 848909465553207296)} {Formatter.MaskedUrl("Qadim the Peerless", new Uri("https://wiki.guildwars2.com/wiki/Qadim_the_Peerless"))} ({Formatter.MaskedUrl("Mukluk", new Uri("https://www.youtube.com/watch?v=v1ZFeRot8zg"))} - {Formatter.MaskedUrl("Hepha Cinema", new Uri("https://www.youtube.com/watch?v=vUELGR2S2Mc"))})");
