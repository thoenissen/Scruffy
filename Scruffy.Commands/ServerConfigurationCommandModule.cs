...
namespace Scruffy.Commands
{
    ...
    public class ServerConfigurationCommandModule : LocatedCommandModuleBase
    {
        ...
        public ServerConfigurationCommandModule(LocalizationService localizationService, UserManagementService userManagementService, IHttpClientFactory httpClientFactory)
