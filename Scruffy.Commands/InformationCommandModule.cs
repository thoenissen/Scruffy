...
public class InformationCommandModule : LocatedCommandModuleBase
{
    ...
    public InformationCommandModule(LocalizationService localizationService, UserManagementService userManagementService, IHttpClientFactory httpClientFactory)
